<?php
namespace edgewizz\fillmcq\Controllers;

use App\Http\Controllers\Controller;
use Edgewizz\Edgecontent\Models\ProblemSetQues;
use Edgewizz\Fillmcq\Models\FillmcqAns;
use Edgewizz\Fillmcq\Models\FillmcqQues;
use Illuminate\Http\Request;

class FillmcqController extends Controller
{
    //
    ...
    public function delete($id){
        $f = FillmcqQues::where('id', $id)->first();
        $f->delete();
        $ans = FillmcqAns::where('question_id', $f->id)->pluck('id');
        if($ans){
            foreach($ans as $a){
                $f_ans = FillmcqAns::where('id', $a)->first();
                $f_ans->delete();
            }
        }
        return back();
    ...
    public function update($id, Request $request){
        $q = FillmcqQues::where('id', $id)->first();
        $q->question = $request->question;
        $q->difficulty_level_id = $request->difficulty_level_id;
        ...
        $q->save();
        $answers = FillmcqAns::where('question_id', $q->id)->get();
